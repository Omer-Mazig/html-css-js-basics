...
// if & else statement with hard-coded boolean value (not really useful, but you get the idea)
if (true) {
...
// We can omit the {} and write the if statement in one line. usful for simple and short code.
const isHappy = true;
